...
public class DialogHelper {
    ...
    public void alert(final String title, final String msg, final String positive,
        ...
        mActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mAlertDialog = (GenericProgressDialog) builder.show();
    ...
    //不可取消对话框
    public void showProgressDialog(final String msg,boolean b) {
        showProgressDialog(msg, b, null, true);
    }
...
public void setProgress(String ms){
 mAlertDialog.upText(ms);
}
}
