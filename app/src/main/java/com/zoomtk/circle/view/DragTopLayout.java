...
public class DragTopLayout extends FrameLayout {
    ...
    private void calculateRatio(float top) {
        ...
        if (mOnDragListener != null) {
            ...
            mOnDragListener.onSliding(ratio);
            if (ratio > refreshRatio && !isRefreshing) {
                isRefreshing = true;
                //mOnDragListener.onRefresh();
            }
        }
    }
    ...
    private void updatePanelState(){
        ...
        if (mOnDragListener != null) {
            mOnDragListener.onPanelStateChanged(panelState);
        }
    }
    ...
    private ViewDragHelper.Callback callback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            int top;
            if (yvel > 0 || contentTop > (topViewHeight*3)/4) {
    ...
    public void openTopView(boolean anim) {
        ...
        if (dragContentView.getHeight() == 0) {
            panelState = PanelState.EXPANDED;
            if (mOnDragListener != null) {
                mOnDragListener.onSliding(1.0f);
            }
        } else {
    ...
    public void closeTopView(boolean anim) {
        if (dragContentView.getHeight() == 0) {
            panelState = PanelState.COLLAPSED;
            if (mOnDragListener != null) {
                mOnDragListener.onSliding(0.0f);
            }
        }else{
     ...
     * @return SetupWizard
     */
    public DragTopLayout attachOnDragListener(OnDragListener onDragListener) {
