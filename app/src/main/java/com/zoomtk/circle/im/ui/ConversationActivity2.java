...
import com.zoomtk.circle.im.base.IMBaseActivity;
...
public class ConversationActivity2 extends IMBaseActivity implements View.OnClickListener{

    private String TAG = ConversationActivity2.class.getSimpleName();
    /**
     * 对方id
     */
...
//            startActivity(new Intent(ConversationActivity2.this, NewFriendListActivity.class));
            return;
        }
...
//        });
        ...
        if (intent.getData().getScheme().equals("rong") && intent.getData().getQueryParameter("isFromPush") != null) {
            ...
            if (intent.getData().getQueryParameter("isFromPush").equals("true")) {
                ...
                if (intent.getData().getPath().contains("conversation/system")) {
                    Intent intent1 = new Intent(mContext, IndexAct.class);
     ...
     * <p>
     * 作用：由于在 manifest 中 intent-filter 是配置在 ConversationActivity2 下面，所以收到消息后点击notifacition 会跳转到 DemoActivity。
     * 以跳到 MainActivity 为例：
     * 在 ConversationActivity2 收到消息后，选择进入 MainActivity，这样就把 MainActivity 激活了，当你读完收到的消息点击 返回键 时，程序会退到
    ...
    private void enterActivity() {
        ...
        if (token.equals("default")) {
            BaseLog.LogE("ConversationActivity2 push", "push2");
            startActivity(new Intent(ConversationActivity2.this, LoginActivity.class));
            AppApplication.getInstance().exit();
        } else {
            BaseLog.LogE("ConversationActivity2 push", "push3");
            reconnect(token);
        }
    }
    ...
    private void reconnect(String token) {
        RongIM.connect(token, new RongIMClient.ConnectCallback() {
            ...
            public void onSuccess(String s) {
                ...
                BaseLog.LogE("ConversationActivity2 push", "push4");
    ...
    private void enterSettingActivity() {
        ...
        if (mConversationType == Conversation.ConversationType.PUBLIC_SERVICE
            ...
            RongIM.getInstance().startPublicServiceProfile(mContext, mConversationType, mTargetId);
        } else {
            ...
            if (TextUtils.isEmpty(mTargetId)) {
                BaseToast.YToastL(mContext, "讨论组尚未创建成功");
            }
            ...
            if (fragment != null && !fragment.onBackPressed()) {
                if (isFromPush) {
                    ...
                    if (fragment.isLocationSharing()) {
                        fragment.showQuitLocationSharingDialog((Activity) mContext);
                        return true;
                    }
