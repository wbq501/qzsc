...
# in /Users/wbq501/Library/Android/sdk/tools/proguard/proguard-android.txt
...
-keep class circle.zoomtk.circle.fragment.OneFragment$*{*;}
-keepclassmembers class circle.zoomtk.circle.fragment.OneFragment{
  public *;
}
-keepattributes *Annotation*
-keepattributes *JavascriptInterface*
...
#防止inline
#-dontoptimize
#-keepclassmembers class com.zoomtk.circle.app.AppApplication{
#    public <init>();
#}
...
#这个牵涉到你的需求如何，如果你使用了EventBus processor进行加速，你就必须加上这个，只要有这个注解的类和方法都不混淆，为反编译提供了便利。。。
